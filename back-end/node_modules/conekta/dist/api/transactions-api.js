...
const TransactionsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTransactions: (acceptLanguage, xChildCompanyId, limit, search, next, previous, options = {}) => __awaiter(this, void 0, void 0, function* () {
...
const TransactionsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTransactions(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getTransactions(acceptLanguage, xChildCompanyId, limit, search, next, previous, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
    };
...
class TransactionsApi extends base_1.BaseAPI {
     ...
     */
    getTransactions(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
        return (0, exports.TransactionsApiFp)(this.configuration).getTransactions(acceptLanguage, xChildCompanyId, limit, search, next, previous, options).then((request) => request(this.axios, this.basePath));
    }
}

...
export declare const TokensApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    createToken: (token: Token, acceptLanguage?: 'es' | 'en', options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const TokensApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createToken(token: Token, acceptLanguage?: 'es' | 'en', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TokenResponse>>;
};
/**
...
export declare class TokensApi extends BaseAPI implements TokensApiInterface {
     ...
     * @memberof TokensApi
     */
    createToken(token: Token, acceptLanguage?: 'es' | 'en', options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TokenResponse, any>>;
}
